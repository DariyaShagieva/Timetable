      ...
      <v-list-tile @click="moveStart" v-if="canMove">
        <v-menu
          ...
          <v-date-picker no-title scrollable
            ...
            v-model="targetDate">
            <v-spacer></v-spacer>
            <v-btn round flat color="primary" @click="movingDate = false">{{ labels.pickerCancel }}</v-btn>
            <v-btn round flat color="primary" @click="moveEnd">{{ labels.pickerOk }}</v-btn>
          </v-date-picker>
          ...
          <v-time-picker no-title scrollable
            ...
            v-model="targetTime">
            <v-spacer></v-spacer>
            <v-btn round color="primary" @click="movingTime = false">{{ labels.pickerCancel }}</v-btn>
            <v-btn round color="primary" @click="moveEnd">{{ labels.pickerOk }}</v-btn>
          </v-time-picker>
      ...
      <v-list-tile @click="includeStart" v-if="canInclude">
        <v-menu
          ...
          <v-date-picker no-title scrollable
            ...
            v-model="targetDate">
            <v-spacer></v-spacer>
            <v-btn round color="primary" @click="includingDate = false">{{ labels.pickerCancel }}</v-btn>
            <v-btn round color="primary" @click="includeEnd">{{ labels.pickerOk }}</v-btn>
          </v-date-picker>
          ...
          <v-time-picker no-title scrollable
            ...
            v-model="targetTime">
            <v-spacer></v-spacer>
            <v-btn round color="primary" @click="includingTime = false">{{ labels.pickerCancel }}</v-btn>
            <v-btn round color="primary" @click="includeEnd">{{ labels.pickerOk }}</v-btn>
          </v-time-picker>
