package ru.itis.timetable.security.config;
...
import ru.itis.timetable.security.filter.JwtTokenAuthFilter;
import ru.itis.timetable.security.provider.JwtTokenAuthProvider;
